...
<table width="785" border="1" align="center" cellpadding="0" cellspacing="0"bordercolor="#FFFFFF" bordercolordark="#333333" bordercolorlight="#FFFFFF">
  <tr>
    <td width="785" height="38" align="center" colspan="6"><font face="隶书" size="7">物流知识</font></td>
  </tr>
  <tr>
    ...
    <td width="14%" height="29" align="center">详细</td>
  </tr>
<%
...
%>
 <tr>
   ...
   <a href="#" onClick="window.open('/logistics/Knowledge/knowledgeshow.jsp?id=<%=code%>','','width=790,height=400');">详细</a></td>
  </tr>
<%
if(!rs.next())
break;
...
共<%=pagecount%>页
        <a href="/logistics/Knowledge/knowledge.jsp?topage=<%=1%>">第一页</a>
        <a href="/logistics/Knowledge/knowledge.jsp?topage=<%=showpage-1%>">上一页</a>
        <a href="/logistics/Knowledge/knowledge.jsp?topage=<%=showpage+1%>">下一页</a>
        <a href="/logistics/Knowledge/knowledge.jsp?topage=<%=pagecount%>">最后一页</a>
        <span class="bgcolor">
