...
<table width="785" height="117" border="1" align="center" cellpadding="0" cellspacing="0"bordercolor="#FFFFFF" bordercolordark="#333333" bordercolorlight="#FFFFFF">
  <tr>
    <td width="786" height="38" align="center" colspan="6"><font face="隶书" size="7">动态信息</font></td>
  </tr>
  <tr>
...
%>
 <tr>
   ...
   <a href="#"onClick="window.open(' /logistics/Active/activeshow.jsp?id=<%=code%>','','width=790,height=530');">详细</a></td>  
  </tr>
<%
if(!rs.next())
break;
...
<table width="786" align="center" cellpadding="0" cellspacing="0">
    ...
    <td width="786" height="30" colspan="9" align="right">
共<%=pagecount%>页
        <a href="/logistics/Active/active.jsp?topage=<%=1%>">第一页</a>
        <a href="/logistics/Active/active.jsp?topage=<%=showpage-1%>">上一页</a>
        <a href="/logistics/Active/active.jsp?topage=<%=showpage+1%>">下一页</a>
        <a href="/logistics/Active/active.jsp?topage=<%=pagecount%>">最后一页</a>
        <span class="bgcolor">
