...
<body bgcolor="#ffffff">
<p align="center"><b><font size="6">货物信息发布</font></b></p>
<form method="POST" action="/logistics/Goods/Good_config.jsp" name="form1">
  <table width="786" border="1" align="center" cellpadding="0" cellspacing="0"bordercolor="#FFFFFF" bordercolordark="#333333" bordercolorlight="#FFFFFF">
    ...
    <tr>
      ...
      <td width="36%" height="43">
        <p align="center"><input type="text" name="gstartfirm" size="20"></p>
      </td>
      <td width="18%" height="43">
    ...
    <tr>
      ...
      <td width="36%" height="46">
        <p align="center"><input type="text" name="gendfirm" size="20"></p>
      </td>
    ...
    <tr>
      <td width="786" height="58" colspan="4">
        ...
        <input type="reset" name="reset" value="重置"> &nbsp;&nbsp;<a href="/logistics/Goods/Goods_show.jsp">返回</a>
      </td>
    </tr>
  </table>
</form>
