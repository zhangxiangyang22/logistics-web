...
sql="select * from db_GoodsMeg where ID="+code;
...
<tr>
  ...
  <tr>
    ...
    <td width="36%" height="29" align="center"><%=rs.getString("StartOmit")%></td>
  ...
  <tr>
    ...
    <td width="36%" height="29" align="center"><%=rs.getString("EndOmit")%></td>
   ...
   %>
    <tr>
      <td width="100%" height="45" colspan="4" align="center">
        <a href="/logistics/Goods/Goods_change.jsp?id=<%=code%>">修改</a>&nbsp;&nbsp;
        <a href="/logistics/Goods/Goods_delete.jsp?id=<%=code%>">删除</a></td>
  </tr>
