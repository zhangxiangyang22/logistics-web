...
<tr>
    <td width="786" align="center" colspan="6" height="32"><font size="6" face="隶书">企业信息</font></td>
  </tr>
<tr>
    <td width="786" align="center" height="27" colspan="6">
      <p align="right"> <a href="/logistics/Enterprise/enterpriseadd.jsp">发布信息...</a></td>
  </tr>
  <tr>
...
%>
 <tr>
    ...
    <td width="17%" align="center"height="27"><a href="/logistics/Enterprise/enterpriseShow.jsp?id=<%=code%>">详细</a>　</td>
  </tr>
<%
if(!rs.next())
break;
...
<table width="786" align="center" cellpadding="0" cellspacing="0">
    ...
    <td width="786" height="30" colspan="6" align="right">
        共<%=pagecount%>页&nbsp;&nbsp;
        <a href="/logistics/Enterprise/enterprise.jsp?topage=<%=1%>">第一页</a>
        <a href="/logistics/Enterprise/enterprise.jsp?topage=<%=showpage-1%>">上一页</a>
        <a href="/logistics/Enterprise/enterprise.jsp?topage=<%=showpage+1%>">下一页</a>
        <a href="/logistics/Enterprise/enterprise.jsp?topage=<%=pagecount%>">最后一页</a>
        <span class="bgcolor">
